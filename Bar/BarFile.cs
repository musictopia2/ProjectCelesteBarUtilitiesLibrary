namespace ProjectCelesteBarUtilitiesLibrary.Bar;
internal class BarEntryLastWriteTime
{
...
internal class BarFile
{
    ...
    public BarFile(BinaryReader binaryReader)
    {
        ...
        var barFileEntrys = new List<BarEntry>(); //okay to use standard list instead of my custom list.
